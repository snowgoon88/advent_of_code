...
advent22_08: 7-segment display: find wiring mapping using constraints. (SMART: compute all possible permutations, using Finite and Finitari and permutations)
